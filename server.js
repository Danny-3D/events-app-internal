...
const mockEvents = {
    events: [
        { title: 'an event', id: 1, description: 'something really cool', location: 'Dannys House', time: '2:00pm' },
        { title: 'another event', id: 2, description: 'something even cooler', location: 'Spongebob House', time: '8:00pm' }
    ]
};
